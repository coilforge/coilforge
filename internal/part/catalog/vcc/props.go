...
// File overview:
// props declares editable vcc properties and applies updates to part state.
// Subsystem: part catalog (vcc) properties.
...
func (self *Vcc) PropSpec() part.PropSpec {
...
func (self *Vcc) ApplyProp(action part.PropAction) bool {
	if action.Index != 0 {
		return false
	}
